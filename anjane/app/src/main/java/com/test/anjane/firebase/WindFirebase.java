...
public class WindFirebase extends AppCompatActivity {
    private static final String TAG = "WindFirebase";
    ...
    private void onAuthSuccess(String areaname, String warnstress, String startTime) {
        db.collection("wind").document(areaname).set(toMap(areaname, warnstress, startTime));
    }
